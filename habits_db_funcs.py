...
def insert_into_habit(title="", duration=0, user_id=0):
    conn = db()
...
def insert_into_day_progress(completed_days=0, habit_id=0, user_id=0):
    conn = db()
...
def get_day_progress_by_user_id_and_habit_id(user_id=0, habit_id=0):
    conn = db()
